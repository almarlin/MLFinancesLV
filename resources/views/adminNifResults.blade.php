...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <form action="{{route('usuarioBan')}}" method="POST">
            @csrf
            <div class="mb-3">
              <label for="inputNif" class="form-label">NIF</label>
              <input type="text"
                class="form-control" name="inputNif" id="inputNif" aria-describedby="helpId" placeholder="">
              <small id="helpId" class="form-text text-muted">Confrima el NIF del usuario</small>
            </div>
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" for="unbanUser">
                Desbloquear usuario
              </label>
            </div>
