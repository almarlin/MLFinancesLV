...
@endsection
@section('script')
<script defer src="{{ asset('../resources/js/validateSend.js') }}"></script>
...
@section('content')
    ...
    <div class="border-red container mt-5 w-25">
        ...
        <form action="{{ route('postEnviar') }}" method="POST" id="form">
            ...
            <div class="mb-3">
                <label for="inputEmail" class="form-label">Destinatario</label>
                <input type="text" class="form-control" name="inputEmail" id="inputEmail" aria-describedby="helpRecipient"
                    placeholder="Email del destinatario" required>
                <small id="helpRecipient" class="form-text text-muted"></small>
            </div>
            ...
            <div class="text-center">
                <button type="submit" class="btn button-red mt-5" onclick="validateForm()">Enviar</button>
            </div>
